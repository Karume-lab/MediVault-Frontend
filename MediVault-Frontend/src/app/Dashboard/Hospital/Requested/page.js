...
export default function Requested() {
  ...
  return (
    <div
      className="bg-cover h-screen w-screen bg-no-repeat pt-0 bg-no-scrol"
      ...
      <div className="flex justify-between p-6 ">
        ...
        <div className="flex pl-6 ">
          <input
            type="text"
            placeholder="Search"
            className="bg-transparent  border-b-8 border-2 shadow-lg  border-black border-opacity-20 rounded-l-xl hover:bg-blue-200 w-64 p-2 focus:outline-none focus:ring focus:ring-blue-100 focus:bg-transparent "
          />
          ...
          <div className="overflow-x-auto mt-6">
            <table className="table-auto border-collapse w-5/6 ml-28 bg-black bg-opacity-25 h-5/6 p-2 m-6 ">
              ...
              <tbody className="text-sm font-normal text-gray-700">
                {requestedPatients.map((patient, index) => (
                  <tr
                    key={index}
                    className="hover:bg-blue-400 border-b border-gray-200 py-10 font-bold text-white"
                  >
